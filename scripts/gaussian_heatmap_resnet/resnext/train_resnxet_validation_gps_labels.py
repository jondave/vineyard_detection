...
class VineyardDataset(Dataset):
    def __init__(self, images_dir, base_dir, image_size=(640, 480)):
    ...
    def __getitem__(self, idx):
        ...
        for cls_idx, cls_name in enumerate(CLASS_NAMES[1:], start=1):
            ...
            cls_mask_dir = os.path.join(self.base_dir, folder_name)
...
print(f"✅ Updated training config with final training summary: {TRAINING_CONFIG_PATH}")
