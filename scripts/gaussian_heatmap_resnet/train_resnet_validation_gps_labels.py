...
# CONFIGURATION
# =======================
# DATASET_ROOT = "dataset_gps_masks/riseholme/full_res"
# DATASET_ROOT = "dataset_gps_masks/riseholme/patches_960x1280"
# DATASET_ROOT = "dataset_gps_masks/riseholme/patches_480x640"

# DATASET_ROOT = "dataset_gps_masks_with_augmentations/riseholme/full_res"
# DATASET_ROOT = "dataset_gps_masks_with_augmentations/riseholme/patches_960x1280"
DATASET_ROOT = "dataset_gps_masks_with_augmentations/riseholme/patches_480x640"

BACKBONE = "resnet18"  # options: "resnet18" or "resnet50"
MODEL_OUTPUT_PATH = f"{BACKBONE}_unet_image_size_640x480_batch_size_8.pth"
...
RESULTS_DIR = os.path.join("results_resnet", RUN_NAME)
...
class VineyardDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for cls_idx, cls_name in enumerate(CLASS_NAMES[1:], start=1):
            ...
            cls_mask_path = os.path.join(self.masks_dir, folder_name, f"{prefix}{img_name}")
...
train_dataset = VineyardDataset(os.path.join(DATASET_ROOT, "train/images"), os.path.join(DATASET_ROOT, "train"))
valid_dataset = VineyardDataset(os.path.join(DATASET_ROOT, "valid/images"), os.path.join(DATASET_ROOT, "valid"))
...
for epoch in range(NUM_EPOCHS):
    ...
    shutil.copy(METRICS_PATH, os.path.join(RESULTS_DIR, "metrics_last.csv"))
