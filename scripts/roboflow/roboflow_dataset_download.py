...
python train.py --batch 4 --epochs 25 --img 640 --device 0 --min-items 0 --close-mosaic 15 --data data/vineyard/vineyard_test-7/data.yaml --weights weights/yolov9-c.pt --cfg models/detect/yolov9-c.yaml --hyp hyp.scratch-high.yaml
