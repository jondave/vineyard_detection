...
plt.savefig('../../images/graph_matching/subgraph/pytorch/2_grapth_matching.png')
plt.close()
...
plt.savefig('../../images/graph_matching/subgraph/pytorch/3_IPFP_grapth_matching.png')
plt.close()
...
plt.savefig('../../images/graph_matching/subgraph/pytorch/4_SM_grapth_matching.png')
plt.close()
...
plt.savefig('../../images/graph_matching/subgraph/pytorch/5_NGM_grapth_matching.png')
plt.close()