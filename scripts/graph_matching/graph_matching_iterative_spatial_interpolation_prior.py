...
geojson_file_prior_knowledge = '../../data/spatial_interpolation_poles_stright_edited.geojson'
...
def main():
    ...
    poles_per_row = [4, 4, 4, 4, 4, 4, 4, 4, 4, 4]
    compass_heading = 170
    spatial_interpolation_stright_poles_only.geojson_poles_spatial_interpolation(geojson_file, geojson_file_prior_knowledge, poles_per_row, compass_heading)
