...
if __name__ == "__main__":
    ...
    for i, image_file in enumerate(image_files, start=1):
        ...
        try:
            ...
            import traceback
            traceback.print_exc() # Added detailed error printing just in case
            continue
    ...
    try:
        geojson_data_poles_clustered = pole_clustering.cluster_poles(
            geojson_data_poles, eps=0.0000002, min_samples=2, metric="chebyshev"
        )
    except Exception as e:
