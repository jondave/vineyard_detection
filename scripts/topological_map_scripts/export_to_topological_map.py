...
def find_centre_from_geojson(geojson_data):
    """Finds the center coordinate of a GeoJSON FeatureCollection containing points and lines."""
    ...
    if not all_coords:  # Handle the case where there are no coordinates
    ...
    center_coordinates = (mean_longitude, mean_latitude)  # Correct order: (longitude, latitude)
